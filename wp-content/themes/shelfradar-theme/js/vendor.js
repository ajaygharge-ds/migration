...
var i = class {
  ...
  Lenis = class {
    ...
    onClick = (t) => {
      const e = t
        .composedPath()
        .find((t) => t instanceof HTMLAnchorElement && (t.getAttribute("href")?.startsWith("#") || t.getAttribute("href")?.startsWith("/#") || t.getAttribute("href")?.startsWith("./#")));
      if (e) {
        ...
        h.find(
          (t) =>
            ...
            (("function" == typeof a && a?.(t)) ||
              ...
              (this.options.allowNestedScroll && this.checkNestedScroll(t, {deltaX: e, deltaY: i})))
        )
      )
        return;
      ...
      "both" === this.options.gestureOrientation ? (c = Math.abs(i) > Math.abs(e) ? i : e) : "horizontal" === this.options.gestureOrientation && (c = e),
        (!this.options.overscroll ||
          ...
          (this.options.wrapper !== window &&
            ((this.animatedScroll > 0 && this.animatedScroll < this.limit) || (0 === this.animatedScroll && i > 0) || (this.animatedScroll === this.limit && i < 0)))) &&
      ...
      function d(e) {
        ...
        if (
          !(
            ...
            a.metaKey ||
            (l.activeElement &&
              (l.activeElement.isContentEditable || (l.activeElement.nodeName && ("input" === l.activeElement.nodeName.toLowerCase() || "textarea" === l.activeElement.nodeName.toLowerCase()))))
          )
        ) {
    ...
    function (e) {
      ...
      function p() {
        ...
        c.forEach((e, r) => {
          ...
          "custom" === s.type && s.renderCustom ? (C(e, s.renderCustom(t, a + 1, u)), 0 === r && i("paginationRender", e)) : (0 === r && i("paginationRender", e), i("paginationUpdate", e)),
    ...
    function (e) {
      ...
      function $(e) {
        ...
        if ((Math.max(Math.abs(b.touchesCurrent.x - b.touchesStart.x), Math.abs(b.touchesCurrent.y - b.touchesStart.y)) > 5 && (t.allowClick = !1), !b.isMoved && !o)) {
          if (
            t.isHorizontal() &&
            ((Math.floor(b.minX) === Math.floor(b.startX) && b.touchesCurrent.x < b.touchesStart.x) || (Math.floor(b.maxX) === Math.floor(b.startX) && b.touchesCurrent.x > b.touchesStart.x))
          )
            return (b.isTouched = !1), void A();
          if (
            !t.isHorizontal() &&
            ((Math.floor(b.minY) === Math.floor(b.startY) && b.touchesCurrent.y < b.touchesStart.y) || (Math.floor(b.maxY) === Math.floor(b.startY) && b.touchesCurrent.y > b.touchesStart.y))
          )
            return (b.isTouched = !1), void A();
        }
      ...
      const x = (e, t, s) => {
        ...
        L = (e) => {
          ...
          a ||
            ...
            requestAnimationFrame(() => {
              r ||
                (t.params.loop ? t.slideToLoop(t.getSlideIndexWhenGrid(parseInt(s.getAttribute("data-swiper-slide-index"))), 0) : t.slideTo(t.getSlideIndexWhenGrid(t.slides.indexOf(s)), 0), (r = !1));
            }));
        },
        I = () => {
          ...
          t.params.a11y.enabled &&
            (function () {
              ...
              a().removeEventListener("visibilitychange", P),
                t.el && "string" != typeof t.el && (t.el.removeEventListener("focus", L, !0), t.el.removeEventListener("pointerdown", S, !0), t.el.removeEventListener("pointerup", M, !0));
            })();
        });
    },
    function (e) {
